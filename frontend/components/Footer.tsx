  ...
  return (
    <footer className="w-full bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-black border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <Divider className="my-6 animate-scaleIn" style={{ animationDelay: '0.2s', animationFillMode: 'both' }} />

        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 animate-fadeIn" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
